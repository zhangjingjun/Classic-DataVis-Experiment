...
Grades on a 120 point scale 100 points will be graded for functionality: the program does what the assignment requests. 
...
100 -- Experiment loads and works with no obvious bugs or design flaws; Experiment results reported with no obvious flaws (i.e. too few participants, data suspiciously different than original results with no explanation as to why it differs, etcetera) 
